...
import { useReactFlow, ReactFlow, Controls, applyEdgeChanges, applyNodeChanges, addEdge, Panel, Background, useUpdateNodeInternals} from '@xyflow/react';
...
function App() {
  ...
  // Uses Dagre to apply layout to graph
  ...
  const onLayout = useCallback(
    ...
    [nodes, edges, updateLayout, updateNodeInternals],
  ...
  return (
    <div className="App" data-theme={colorMode}>
      ...
      {/* <header className="App-header"> */}
        <Toolbar setLayout={() => onLayout("TB")} toggleGraphVisible={() => setVisibleObjects({...visibleObjects, graph : !visibleObjects.graph})} toggleWorkflowVisible={() => setVisibleObjects({...visibleObjects, workflow : !visibleObjects.workflow})} visibleObjects={visibleObjects}  setVisibleObjects={setVisibleObjects} setEditType={setEditType} createNewEdge={createNewEdge} updateWorkflowAndLayout={updateWorkflowAndLayout}></Toolbar>
      {/* </header> */}
